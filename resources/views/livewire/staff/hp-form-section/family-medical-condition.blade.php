<div>
    ...
    <div class="grid gap-6 ml-6 mb-6 md:grid-cols-2">
        ...
        <!-- Mother Side -->
        <div>
            <label for="mother-side" class="mb-2 text-sm font-medium text-gray-900 dark:text-white">Mother Side</label>

            <!-- Display existing conditions -->
            <div class="mb-4">
                @foreach ($motherConditions as $index => $condition)
                    <p class="text-gray-900 dark:text-white">{{ $condition }}</p>
                @endforeach
            </div>

            <!-- Input field for adding new conditions -->
            <div class="flex items-center gap-3 mb-3">
                <input type="text" wire:model="newMotherCondition"
        ...
        <div>
            ...
            <!-- Input field for adding new conditions -->
            <div class="flex items-center gap-3 mb-3">
                <input type="text" wire:model="newFatherCondition"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Add new condition" />
            </div>
