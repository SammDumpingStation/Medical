<div class="">
                        ...
                        <tr
                            ...
                            <td class="flex items-center p-4">
                                <textarea wire:model="diagnosis" id="diagnosis" rows="4"
                                    ...
                                    placeholder="Write the diagnosis here..." oninput="this.value=this.value.replace(/[^a-zA-Z\s]/g, '');"
                            ...
                            <td
                                ...
                                <textarea wire:model="remarks" id="remarks" rows="4"
                                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Write your remarks here..." required oninput="this.value=this.value.replace(/[^a-zA-Z\s]/g, '');"
                                    title="Only letters and spaces are allowed"></textarea>
    ...
    <div class="flex items-center justify-between w-full">
        ...
        @if ($gender === 'Female')
            <a href="/health-profile/create-form-3/{{ $patientID }}" wire:click="savePersonalRemarks"
                class="mt-5 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Next
            </a>
        @else
            <a href="/health-profile/create-form/{{ $patientID }}/summary" wire:click="savePersonalRemarks"
                class="mt-5 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Next
            </a>
        @endif
