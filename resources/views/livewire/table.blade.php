                            ...
                            <tbody class="bg-white dark:bg-gray-800">
                                @for ($i = 0; $i < 10; $i++)
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700 ">
                                        ...
                                        <td
                                            class="max-w-sm p-4 overflow-hidden text-gray-900 text-base font-normal truncate xl:max-w-xs dark:text-gray-400">
                                            Samm Caagbay</td>
                                        <td
                                            class="p-4 text-base font-medium text-gray-500 whitespace-nowrap dark:text-white">
                                            21</td>
                                        <td
                                            class="p-4 text-base font-medium text-gray-500 whitespace-nowrap dark:text-white">
                                            Male</td>
                                        <td
                                            class="p-4 text-base font-normal text-gray-500 whitespace-nowrap dark:text-white">

                                            CITC
                                        </td>
                                        <td class="p-4 text-gray-900 font-semibold space-x-2 whitespace-nowrap">
                                            Fever
                                        </td>
                                        <td class="p-4 space-x-2 text-gray-500 whitespace-nowrap">
                                            2024-30-31
                                        </td>
                                    </tr>
                                @endfor
