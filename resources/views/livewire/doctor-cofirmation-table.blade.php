<div class="space-y-6 w-full" x-data="{ isModalOpen: @entangle('isModalOpen') }">
    ...
    <!-- Modal -->
    <div x-show="isModalOpen" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50" x-transition>
            ...
            <div class="relative bg-white rounded-lg shadow-lg dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-4 text-lg font-normal text-gray-500 dark:text-gray-400">Confirm this patient's health
                        profile?</h3>
                    <div class="space-x-2">
                        <button type="button" class="px-6 py-2.5 text-sm text-white bg-green-600 rounded-lg focus:outline-none focus:ring-4 focus:ring-green-300 dark:bg-green-500 dark:hover:bg-green-600 dark:focus:ring-green-800"
                            wire:click="confirmProfile">Yes</button>
                        <button type="button" class="px-6 py-2.5 text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-500 dark:focus:ring-gray-600"
