<nav class="fixed z-30 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 no-print">
                        ...
                        <ul class="py-1" role="none">
                            ...
                            <li>
                                <form action="/logout" class="w-full" method="POST">
                                    @csrf
                                    <button type="submit"
                                        class="block px-4 py-2 w-full text-start text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white"
