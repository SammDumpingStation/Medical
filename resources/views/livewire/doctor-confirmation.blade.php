                    ...
                    <div class="sm:flex">
                        <form wire:submit.prevent="confirmProfile" class="max-w-md w-full">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="default-search" wire:model.live.debounce.500ms='patient_id'
                                    class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Search Patient by ID" required />
                                <button type="submit"
                                    class="hover:bg-blue-800 text-white absolute end-2.5 bottom-2.5 bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search
                                    & Confirm</button>
                            </div>
                        </form>
                    </div>
                    ...
                    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="doctor-confirmation-tab"
                        ...
                        <li class="me-2" role="presentation">
                            <button class="inline-block p-4 border-b-2 rounded-t-lg" id="health-profile-tab"
                                data-tabs-target="#health-profile" type="button" role="tab"
                                aria-controls="health-profile" aria-selected="false">Health Profile Creation</button>
                        </li>
                        <li class="me-2" role="presentation">
