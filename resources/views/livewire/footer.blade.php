     <footer
         class="p-4 my-4 h-full bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 xl:p-8 dark:bg-gray-800 no-print">
         <ul class="flex flex-wrap items-center mb-6 space-y-1 md:mb-0">
             ...
             <li><a href="#"
                     ...
                     Policy</a></li>
             <li><a href="#"
                     class="text-sm font-normal text-gray-500 hover:underline dark:text-gray-400">Contact</a></li>
         </ul>
