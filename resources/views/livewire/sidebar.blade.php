  <aside id="sidebar"
      class="{{ $sidebar ? 'w-64' : 'w-[70px]' }} fixed top-0 left-0 z-20 flex flex-col translate-x-0 h-full pt-16 font-normal transition-all duration-300 ease-in-out"
      aria-label="Sidebar">
      <div
          ...
          <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
              <div
                  ...
                  <ul class="pb-4 space-y-4">
                      ...
                      <livewire:sidebar-list label="Dashboard" :active="request()->is('staff')" href="/"
