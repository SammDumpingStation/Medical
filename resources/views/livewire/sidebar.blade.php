  <aside id="sidebar"
      class="sm:hidden fixed top-0 left-0 z-20  flex-col flex-shrink-0 w-64 h-full pt-16 font-normal duration-75 lg:flex transition-width"
      aria-label="Sidebar">
      <div
          ...
          <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
              <div
                  ...
                  <ul class="pb-4 space-y-4">
                      ...
                      <livewire:sidebar-list label="Dashboard" :active="request()->is('dashboard')" href="/"
